                  ...
                  children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text("Find SaveXtra Happy Deals in your city",maxLines: 2,style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                              ),
                              SizedBox(height: 10,),
                              Padding(
                    ...
                    Padding(padding: const EdgeInsets.only(top:13.0,left:8.0,right: 8.0,),
                      child: Row(
                        ...
                        children: <Widget>[
                         Container(child: new Text('SaveXtra Deal', style: TextStyle(fontWeight: FontWeight.w700,fontSize: 18,color: Colors.black54),)),
